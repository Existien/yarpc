...
namespace DictKeysInterfaceUtils {
...
class Uint8MethodArgs {
     ...
     * @brief the value
     */
    Q_PROPERTY(QMap<uchar, QString> value MEMBER value)
public:
...
class BoolMethodArgs {
     ...
     * @brief the value
     */
    Q_PROPERTY(QMap<bool, QString> value MEMBER value)
public:
...
class Int16MethodArgs {
     ...
     * @brief the value
     */
    Q_PROPERTY(QMap<short, QString> value MEMBER value)
public:
...
class Uint16MethodArgs {
     ...
     * @brief the value
     */
    Q_PROPERTY(QMap<ushort, QString> value MEMBER value)
public:
...
class Int32MethodArgs {
     ...
     * @brief the value
     */
    Q_PROPERTY(QMap<int, QString> value MEMBER value)
public:
...
class Uint32MethodArgs {
     ...
     * @brief the value
     */
    Q_PROPERTY(QMap<uint, QString> value MEMBER value)
public:
...
class Int64MethodArgs {
     ...
     * @brief the value
     */
    Q_PROPERTY(QMap<qlonglong, QString> value MEMBER value)
public:
...
class Uint64MethodArgs {
     ...
     * @brief the value
     */
    Q_PROPERTY(QMap<qulonglong, QString> value MEMBER value)
public:
...
class DoubleMethodArgs {
     ...
     * @brief the value
     */
    Q_PROPERTY(QMap<double, QString> value MEMBER value)
public:
...
class StringMethodArgs {
     ...
     * @brief the value
     */
    Q_PROPERTY(QMap<QString, QString> value MEMBER value)
public:
...
signals:
     ...
     */
    void uint8MethodCalled(DictKeysInterfaceUtils::Uint8MethodPendingReply* reply);
     ...
     * @param reply the reply object containing the call arguments and means to reply
     */
    void boolMethodCalled(DictKeysInterfaceUtils::BoolMethodPendingReply* reply);
     ...
     * @param reply the reply object containing the call arguments and means to reply
     */
    void int16MethodCalled(DictKeysInterfaceUtils::Int16MethodPendingReply* reply);
     ...
     * @param reply the reply object containing the call arguments and means to reply
     */
    void uint16MethodCalled(DictKeysInterfaceUtils::Uint16MethodPendingReply* reply);
     ...
     * @param reply the reply object containing the call arguments and means to reply
     */
    void int32MethodCalled(DictKeysInterfaceUtils::Int32MethodPendingReply* reply);
     ...
     * @param reply the reply object containing the call arguments and means to reply
     */
    void uint32MethodCalled(DictKeysInterfaceUtils::Uint32MethodPendingReply* reply);
     ...
     * @param reply the reply object containing the call arguments and means to reply
     */
    void int64MethodCalled(DictKeysInterfaceUtils::Int64MethodPendingReply* reply);
     ...
     * @param reply the reply object containing the call arguments and means to reply
     */
    void uint64MethodCalled(DictKeysInterfaceUtils::Uint64MethodPendingReply* reply);
     ...
     * @param reply the reply object containing the call arguments and means to reply
     */
    void doubleMethodCalled(DictKeysInterfaceUtils::DoubleMethodPendingReply* reply);
     ...
     * @param reply the reply object containing the call arguments and means to reply
     */
    void stringMethodCalled(DictKeysInterfaceUtils::StringMethodPendingReply* reply);
