...
namespace EnumsWithDictsInterfaceUtils {
...
class EnumMethodArgs {
     ...
     * @brief a color
     */
    Q_PROPERTY(QMap<Color::Type, Color::Type> color MEMBER color)
public:
...
public:
     ...
     */
    void setEnumProperty(const QMap<Color::Type, Color::Type> &value );
...
signals:
     ...
     */
    void enumMethodCalled(EnumsWithDictsInterfaceUtils::EnumMethodPendingReply* reply);
     ...
     * @param value the new value of the property
     */
    void propertyEnumPropertySet(QMap<Color::Type, Color::Type> value);
...
private:
    ...
    QMap<Color::Type, Color::Type> m_EnumProperty = {};
};
