...
namespace BackendEnumsWithDictsClientUtils {
...
signals:
     ...
     * @param another color
     */
    void finished(const QMap<Color::Type, Color::Type> &reply);
...
/**
 * D-Bus client for the com.yarpc.backend.enumsWithDicts D-Bus interface
 */
class BackendEnumsWithDictsClient : public QObject {
    Q_OBJECT
    QML_ELEMENT
    /**
...
public:
    BackendEnumsWithDictsClient(QObject* parent = nullptr);
     ...
     */
    BackendEnumsWithDictsClientUtils::EnumMethodPendingCall* EnumMethod(
     ...
     * a property
     */
    QMap<Color::Type, Color::Type> getEnumProperty() const;
     ...
     * a property
     */
    void setEnumProperty(const QMap<Color::Type, Color::Type> &newValue);
