...
namespace EnumsWithArraysInterfaceUtils {
...
class EnumMethodArgs {
     ...
     * @brief a color
     */
    Q_PROPERTY(QList<Color::Type> color MEMBER color)
public:
...
public:
     ...
     */
    void setEnumProperty(const QList<Color::Type> &value );
...
signals:
     ...
     */
    void enumMethodCalled(EnumsWithArraysInterfaceUtils::EnumMethodPendingReply* reply);
     ...
     * @param value the new value of the property
     */
    void propertyEnumPropertySet(QList<Color::Type> value);
...
private:
    ...
    QList<Color::Type> m_EnumProperty = {};
};
