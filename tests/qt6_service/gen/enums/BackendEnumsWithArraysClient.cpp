...
using namespace BackendEnumsWithArraysClientUtils;
...
EnumMethodPendingCall* BackendEnumsWithArraysClient::EnumMethod(
    ...
    dbuscolor << *reinterpret_cast<const QList<int>*>(&color);
    QDBusInterface iface(
        "com.yarpc.backend",
        "/com/yarpc/backend/enums",
        "com.yarpc.backend.enumsWithArrays",
...
void EnumMethodPendingCall::callFinished(QDBusPendingCallWatcher *watcher)
{
    ...
    if (!reply.isValid()) {
        ...
        QList<int> finishedReply = reply;
        emit finished(*reinterpret_cast<const QList<Color::Type>*>(&finishedReply));
    }
    deleteLater();
}
...
QList<Color::Type> BackendEnumsWithArraysClient::getEnumProperty() const {
    QDBusInterface iface(
        "com.yarpc.backend",
        "/com/yarpc/backend/enums",
        "org.freedesktop.DBus.Properties",
...
void BackendEnumsWithArraysClient::setEnumProperty(const QList<Color::Type> &newValue) {
    QDBusInterface iface(
        "com.yarpc.backend",
        "/com/yarpc/backend/enums",
        "org.freedesktop.DBus.Properties",
    ...
    QDBusVariant v;
    v.setVariant(QVariant::fromValue(*reinterpret_cast<const QList<int>*>(&newValue)));
    marshalled << v;
    iface.call(
        "Set",
        "com.yarpc.backend.enumsWithArrays",
