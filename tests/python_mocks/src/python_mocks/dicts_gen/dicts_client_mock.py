...
class DictsClientMock():
    """
    Mock client implementation of the Dicts D-Bus interface
    ...
    def __init__(self):
        self.name = "com.yarpc.testservice.dicts"
    ...
    async def connect(self):
        ...
        try:
            ...
            self._interface.on_dict_signal(self._DictSignal_handler)
    ...
    def disconnect(self):
        ...
        if self._DictSignal_handler:
            self._interface.off_dict_signal(self._DictSignal_handler)
        if self._properties_changed_handler:
