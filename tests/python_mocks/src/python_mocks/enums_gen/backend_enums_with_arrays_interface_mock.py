...
class BackendEnumsWithArraysInterfaceMock():
    ...
    def on_EnumProperty_changed(self, handler) -> None:
        ...
        Args:
            handler(Callable[[Sequence[Color], dict], Awaitable[dict]]): the properties change handler
    ...
    async def _default_EnumProperty_change_handler(value: Sequence[Color], _: dict) -> dict:
