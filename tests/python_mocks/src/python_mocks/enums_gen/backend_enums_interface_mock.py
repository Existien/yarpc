...
class _Interface(ServiceInterface):
    ...
    Args:
        wrapper(BackendEnumsInterfaceMock): Wrapper responsible for (un-)marhsalling D-Bus types
    """

    def __init__(self, wrapper):
        super().__init__("com.yarpc.backend.enums")
...
class BackendEnumsInterfaceMock():
    """
    Mock service implementation of the Enums D-Bus interface.
    ...
    def __init__(
        ...
        self._EnumProperty_change_handler = BackendEnumsInterfaceMock._default_EnumProperty_change_handler
    ...
    def on_EnumProperty_changed(self, handler) -> None:
        ...
        Args:
            handler(Callable[[Color, dict], Awaitable[dict]]): the properties change handler
    ...
    async def _default_EnumProperty_change_handler(value: Color, _: dict) -> dict:
