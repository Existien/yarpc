from .enums_gen.enums_with_arrays_interface import EnumsWithArraysInterface
from .enums_gen.backend_enums_with_arrays_client import BackendEnumsWithArraysClient
from .enums_gen.enum_struct import Color

class ProxyProperties:
    """Forwards all calls to backend interface"""
    def __init__(self, backend: BackendEnumsWithArraysClient):
...
def get_enums_with_arrays_service_and_backend_client():
    backend_client = BackendEnumsWithArraysClient()
    service = EnumsWithArraysInterface(
