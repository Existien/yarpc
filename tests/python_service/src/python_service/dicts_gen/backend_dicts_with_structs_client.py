...
class BackendDictsWithStructsClient():
    ...
    def disconnect(self):
        ...
        if self._DictStructSignal_handler:
            self._interface.off_dict_struct_signal(self._DictStructSignal_wrapper)
        if self._properties_changed_handler:
