from .enums_gen.enums_with_dicts_interface import EnumsWithDictsInterface
from .enums_gen.backend_enums_with_dicts_client import BackendEnumsWithDictsClient
from .enums_gen.enum_struct import Color

class ProxyProperties:
    """Forwards all calls to backend interface"""
    def __init__(self, backend: BackendEnumsWithDictsClient):
...
def get_enums_with_dicts_service_and_backend_client():
    backend_client = BackendEnumsWithDictsClient()
    service = EnumsWithDictsInterface(
