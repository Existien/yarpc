...
class BackendEnumsWithArraysClient():
    ...
    def __init__(self):
        self.name = "com.yarpc.backend.enumsWithArrays"
    ...
    def on_EnumSignal(self, handler):
        ...
        Args:
            handler (Callable[[Sequence[Color]], None]): the signal handler
        """
    ...
    async def set_EnumProperty(self, value: Sequence[Color]) -> None:
